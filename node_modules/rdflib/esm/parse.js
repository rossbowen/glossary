...
import { TurtleContentType, N3ContentType, RDFXMLContentType, XHTMLContentType, HTMLContentType, SPARQLUpdateContentType, JSONLDContentType, NQuadsContentType, NQuadsAltContentType } from './types';
...
export default function parse(str, kb, base) {
  ...
  try {
    if (contentType === N3ContentType || contentType === TurtleContentType) {
      ...
      executeCallback();
    } else if (contentType === SPARQLUpdateContentType) {
      // @@ we handle a subset
